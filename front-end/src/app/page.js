        ...
        <main className="bg-orange-50">
            ...
            <div className="flex flex-wrap items-center justify-center p-5">
                <p className="m-1 text-2xl justify-stretch items-stretch text-center ">
                    ...
                    las mejores recetas caseras. !Únete a nuestra comunidad y
                    empieza a cocinar con nosotros!
                </p>
            </div>

            <div className="flex justify-center items-center text-center space-x-10 mr-auto p-10 ">
                <Button className="top-2 w-40 h-14  bg-lime-600 rounded-xl hover:bg-lime-800 md:w-52 md:h-10 sm:w-40 ">
                    <p className="text-black">Registrarse</p>
                </Button>
                <Button className="w-40 h-14 bg-violet-950 rounded-xl hover:bg-lime-800 md:w-52 md:h-10 sm:w-40">
